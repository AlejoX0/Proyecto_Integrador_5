...
const departamentos = {
  ...
  Atlantico: { minLat: 10.5, maxLat: 11.2, minLng: -75.2, maxLng: -74.5 },
  Bolivar: { minLat: 8.0, maxLat: 10.8, minLng: -75.9, maxLng: -73.5 },
  Boyaca: { minLat: 4.8, maxLat: 6.3, minLng: -74.5, maxLng: -72.0 },
  Caldas: { minLat: 4.6, maxLat: 5.8, minLng: -75.8, maxLng: -74.8 },
  Caqueta: { minLat: -1.5, maxLat: 2.0, minLng: -76.0, maxLng: -72.0 },
  ...
  Choco: { minLat: 4.0, maxLat: 8.6, minLng: -78.9, maxLng: -76.5 },
  Cordoba: { minLat: 7.3, maxLat: 9.2, minLng: -76.4, maxLng: -74.5 },
  Cundinamarca: { minLat: 4.0, maxLat: 5.6, minLng: -75.0, maxLng: -73.3 },
  Guainia: { minLat: 0.0, maxLat: 3.5, minLng: -70.0, maxLng: -66.8 },
  ...
  Quindio: { minLat: 4.2, maxLat: 4.8, minLng: -75.9, maxLng: -75.3 },
  Risaralda: { minLat: 4.6, maxLat: 5.5, minLng: -76.2, maxLng: -75.3 },
  SanAndres: { minLat: 12.5, maxLat: 13.5, minLng: -82.0, maxLng: -81.5 },
  ...
  Vaupes: { minLat: -1.5, maxLat: 2.0, minLng: -71.8, maxLng: -69.5 },
  Vichada: { minLat: 3.0, maxLat: 6.0, minLng: -71.0, maxLng: -67.0 },
  BogotaDC: { minLat: 4.4, maxLat: 4.9, minLng: -74.3, maxLng: -73.9 }
};
